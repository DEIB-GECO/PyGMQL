...
class GenometricSpace:
    ...
    @classmethod
    def from_memory(cls, data, meta, meta_to_string=True, meta_to_string_delimiter=', '):
        """
        ...
        :param meta_to_string: convert metadata array to string with string concat
        :param meta_to_string_delimiter: if meta_to_string true then use this character as delimiter
        ...
        obj.meta = meta
        if meta_to_string:
            obj.meta = obj.meta.applymap(lambda x: meta_to_string_delimiter.join(x))
        obj.meta.index.names = ['sample']
        obj.meta['sample'] = obj.meta.index
