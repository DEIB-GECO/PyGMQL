...
BACKEND_URL = "https://github.com/DEIB-GECO/PyGMQL/releases/download/backend-stable/GMQL-PythonAPI-1.0-main-SNAPSHOT-jackofall.jar"
...
class DependencyManager:
    ...
    def is_backend_present(self):
        return self.backend_jar_path is not None
